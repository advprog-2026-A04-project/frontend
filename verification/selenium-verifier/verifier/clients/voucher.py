...
class VoucherClient(BaseApiClient):
    ...
    def list_admin(self, admin_token: str, status: str | None = None, **kwargs):
    ...
    def create_admin(self, admin_token: str, body: dict, **kwargs):
        return self.request(
            "POST",
            "/admin/vouchers",
            headers={"X-Admin-Token": admin_token},
    ...
    def update_admin(self, admin_token: str, voucher_id: int, body: dict, **kwargs):
        return self.request(
            "PUT",
    ...
    def disable_admin(self, admin_token: str, voucher_id: int, **kwargs):
        return self.request(
            "POST",
